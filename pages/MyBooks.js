...
const MyBooks = () => {
    ...
    return(
    <div>
      <h1 style={{textAlign: 'center', color: '#356659'}}>Currently Reading</h1>
      ...
      <h1 style={{textAlign: 'center', color: '#356659'}}>Read</h1>
      <div className="recommended-container">
        {read.map((book) => (
          <div key={book._id} className="recommended-card">
            <img src={book.image} alt={book.title} className="recommended-cover" />
      ...
      <h1 style={{textAlign: 'center', color: '#356659'}}>Wants to Read</h1>
      <div className="recommended-container">
        {want.map((book) => (
          <div key={book._id} className="recommended-card">
            <img src={book.image} alt={book.title} className="recommended-cover" />
